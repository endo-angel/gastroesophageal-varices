...
def test_fold(to_chk_path, model, target_img_size, copy_err_files, preprocess_input, binary_threshold=0.5):
    ...
    class_count = len(os.listdir(to_chk_path))
...
# configs
root_path = r'F:\gastroesophageal-varices\grade_classify_imgs'
...
if __name__ == '__main__':
    ...
    test_fold(test_path, model, img_size, copy_err_files, preprocess_input)
